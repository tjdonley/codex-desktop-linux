...
run_deb_job() {
    ...
    assert_contains_file /tmp/deb-contents.txt './opt/codex-desktop/update-builder/scripts/lib/plugin-containment.js'
...
run_rpm_job() {
    ...
    assert_contains_file /tmp/rpm-contents.txt '/opt/codex-desktop/update-builder/scripts/lib/plugin-containment.js'
...
run_pacman_job() {
    ...
    assert_contains_file /tmp/pacman-contents.txt 'opt/codex-desktop/update-builder/scripts/lib/plugin-containment.js'
